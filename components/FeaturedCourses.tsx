...
function FeaturedCourses() {
    ...
    const courses = courseData.courses.filter((course: Courses) => course.isFeatured)
    ...
    return (
        <div className="py-12 bg-gray-900">
                        ...
                        <div key={course.id} className="flex justify-center">
                            <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                                <div className="p-4 sm:p-6 flex flex-col items-center text-center grow">
                                    <img className="rounded-xl w-40vw h-[30vh] md:w-[20vw]" src={course.image} alt="image" />
            ...
            <div className="mt-20 text-center">
                <Link href={"/courses"} className="p-4 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 active:bg-blue-800">
                    View All Courses
                </Link>
            </div>
        </div>

...
function HeroSection() {
    return (
        <div
            className="h-auto md:h-[640px] w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0"
        >
            <Spotlight
            ...
            <div className="p-4 relative z-10 w-full text-center" >
                <h1 className="mt-20 md:mt-0 text-4xl md:text-7xl font-bold bg-clip-text text-white from-neutral-50 to-neutral-400">Master the art of music</h1>
                <p
